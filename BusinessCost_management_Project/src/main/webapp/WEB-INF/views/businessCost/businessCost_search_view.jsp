...
<script type="text/javascript">
	$(function() {
		$("#limit").change(
				function() {
					location.href = "./MemberSearch.me?limit=" + $(this).val()
							+ "&keyword=${keyword}";
				});
		if ("${!empty limit}") {
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							...
							<p align="right">검색된 회원: ${listCount}명</p>
									...
									<c:when test="${listCount > 0}">
										<c:forEach var="arrayList" items="${arrayList}">
											<tr class="text-center">
												<td>${arrayList.num}</td>
												<td><a
													href="./MemberSelectDetail.me?id=${arrayList.id}">${arrayList.id}</a></td>
							...
							<ul class="pagination justify-content-center">
								<c:choose>
									...
									<c:otherwise>
										<li class="page-item"><a
											href="./MemberSearch.me?page=${page-1}&limit=${limit}&keyword=${keyword}"
								...
								<c:forEach var="start" begin="${startpage}" end="${endpage}"
									...
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a
												href="./MemberSearch.me?page=${start}&limit=${limit}&keyword=${keyword}"
